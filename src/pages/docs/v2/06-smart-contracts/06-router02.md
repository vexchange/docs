...
Removes liquidity from an VIP-180⇄VVET pool and receive VET without pre-approval, thanks to <Link to='/docs/v2/smart-contracts/pair-vip-180/#permit'>permit</Link>.
